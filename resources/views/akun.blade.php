                ...
                <table class="table text-nowrap align-middle mb-0">
                  ...
                  <tbody class="table-group-divider">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="javascript:void(0)" class="link-primary text-dark fw-medium d-block">{{ $data->akun }}</a>
                      </td>
                      <td>
                        <a href="javascript:void(0)" class="link-primary text-dark fw-medium d-block">{{ $data->sub_kategori_akun->sub_kategori_akun }}</a>
                      </td>
                      <td>
