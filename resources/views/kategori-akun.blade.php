                  ...
                  <tbody class="table-group-divider">
                    ...
                    <tr>
                      <th scope="row" class="ps-0 fw-medium">
                        <span class="table-link1 text-truncate d-block">{{ $data->kode_kategori_akun }}</span>
                      </th>
                      <td>
                        <a href="javascript:void(0)" class="link-primary text-dark fw-medium d-block">{{ $data->kategori_akun }}</a>
                      </td>
                      <td>
                    ...
                    {{-- <tr>
                      ...
                      <td>
                        <a href="javascript:void(0)" class="link-primary text-dark fw-medium d-block">Aktiva</a>
                      </td>
                      <td>
                        <button type="button" class="btn btn-outline-danger m-1">Danger</button>
                        <button type="button" class="btn btn-outline-warning m-1">Warning</button>
